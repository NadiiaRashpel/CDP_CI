...
Feature: Regression Add place
  ...
  Scenario: REGRESSION I can add places at the OSM via Breadcrumbs
    Given As Users with IT Department and Super Admin role
